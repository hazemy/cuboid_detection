...
def do_training(train):
    ...
    cfg.DATASETS.TEST = () #used to obtain validation loss during training - do Not remove
    # cfg.TEST.EVAL_PERIOD = 100 #number of iterations at which evaluation is run (to obtain validation loss)
